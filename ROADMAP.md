...
- [ ] npm publish completed <!-- rs:task=p2-npm-publish-completed -->
- [ ] skills.sh submission completed <!-- rs:task=p2-skills-sh-submission-completed -->

## Release Milestones
- [x] v0.1: Internal release checklist stabilized <!-- rs:task=milestone-v0-1-internal-release-checklist-stabilized -->
- [ ] v0.2: Public repository and install discovery readiness <!-- rs:task=milestone-v0-2-public-repository-and-install-discovery-readiness -->
- [ ] v1.0: Public npm + skills.sh availability <!-- rs:task=milestone-v1-0-public-npm-and-skills-sh-availability -->
